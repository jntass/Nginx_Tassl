...
static ngx_command_t  ngx_stream_proxy_commands[] = {
    ...
    { ngx_string("proxy_ssl_certificate_key"),
     ...
     { ngx_string("proxy_ssl_enc_certificate"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_proxy_srv_conf_t, certificates_enc),
      NULL },
    ...
    { ngx_string("proxy_ssl_enc_certificate_key"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_proxy_srv_conf_t, certificate_enc_keys),
      NULL },
...
ngx_stream_proxy_set_ssl(ngx_conf_t *cf, ngx_stream_proxy_srv_conf_t *pscf)
{
    ...
    if (pscf->ssl_certificate.len) {
        ...
        if (ngx_ssl_certificate(cf, pscf->ssl, &pscf->ssl_certificate,
                                &pscf->ssl_certificate_key, &pscf->certificates_enc, &pscf->certificate_enc_keys, pscf->ssl_passwords)
            != NGX_OK)
        {
            return NGX_ERROR;
        }
